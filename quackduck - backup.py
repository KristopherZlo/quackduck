...
class Duck(QtWidgets.QWidget):
    ...
    def create_heart(self):
        ...
        """
        # Убедитесь, что предыдущий объект удалён перед созданием нового
    ...
    def open_settings(self):
        ...
        if hasattr(self, 'settings_manager_window') and self.settings_manager_window is not None:
            ...
            # Создаём новое окно и сохраняем ссылку
            self.settings_manager_window = SettingsWindow(self)
            self.settings_manager_window.show()

            # Убираем ссылку на окно при его закрытии
...
class SettingsWindow(QMainWindow):
    ...
    def create_default_skin_item(self, frames):
        ...
        # Локальная функция для обновления кадров анимации
        def update_frame():
